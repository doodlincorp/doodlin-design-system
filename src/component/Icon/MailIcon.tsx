    ...
    >
      ...
      {variant === 'open' && (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            id="icon__fill"
            d="M21.555 8.168L12.555 2.168C12.3908 2.05857 12.1978 2.00018 12.0005 2.00018C11.8032 2.00018 11.6102 2.05857 11.446 2.168L2.446 8.168C2.3089 8.25923 2.19645 8.38292 2.11865 8.52806C2.04084 8.6732 2.00009 8.83532 2 9V20C2 21.103 2.897 22 4 22H20C21.103 22 22 21.103 22 20V9C22 8.666 21.833 8.354 21.555 8.168ZM12 4.202L19.197 9L12 13.798L4.803 9L12 4.202ZM4 20V10.869L11.445 15.832C11.6093 15.9416 11.8025 16.0001 12 16.0001C12.1975 16.0001 12.3907 15.9416 12.555 15.832L20 10.869L19.997 20H4Z"
            fill={color || EColorMap.gray_8}
          />
        </svg>
      )}
        ...
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <path
              ...
              fillRule="evenodd"
              clipRule="evenodd"
              d="M16.6206 17.0348L14 19.6554L15.4142 21.0696L18.0348 18.449L20.6554 21.0696L22.0696 19.6554L19.449 17.0348L22.0696 14.4142L20.6554 13L18.0348 15.6206L15.4142 13L14 14.4142L16.6206 17.0348Z"
            ...
            <path
              ...
              fillRule="evenodd"
              clipRule="evenodd"
              d="M3.8 4H18.2C19.1927 4 20 4.78487 20 5.75V11.6967L18.25 13.4467L18.2011 13.3979L18.2 8.4135L11.5526 13.4404C11.3906 13.5637 11.1953 13.625 11 13.625C10.8047 13.625 10.6094 13.5637 10.4474 13.4404L3.8 8.4135V16.25H13.9822L14.7145 16.9823L13.6967 18H3.8C2.8073 18 2 17.2151 2 16.25V5.75C2 4.78487 2.8073 4 3.8 4ZM18.2 6.19713V5.75H3.8V6.198L11 11.6423L18.2 6.19713Z"
              fill={color || EColorMap.gray_8}
            />
          </svg>
        </svg>
